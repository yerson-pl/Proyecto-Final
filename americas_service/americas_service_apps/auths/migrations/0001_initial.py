...
import americas_service_apps.auths.models.user
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', americas_service_apps.auths.models.user.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Hierarchy',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('gender', models.CharField(choices=[('M', 'Masculino'), ('F', 'Femenino')], max_length=40)),
                ('documento_identidad', models.CharField(help_text='documento nacional de identidad', max_length=8, unique=True, verbose_name='DNI')),
                ...
                ('last_name', models.CharField(help_text='apellido paterno', max_length=50, verbose_name='Last name')),
                ('mother_last_name', models.CharField(help_text='apellido materno', max_length=50, verbose_name="Mother's last name")),
